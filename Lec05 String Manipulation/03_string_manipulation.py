...
txt = "Manhattan" # length = 9
print(txt.center(35))  # 35 = the text size + 35-9/2 [left white space + right white space]

print("\n----- Use of expandtabs() --- how many spaces between tabs -----")
# https://docs.python.org/3.10/library/stdtypes.html#str.expandtabs
txt1 = "H\te\tl\tl\to"
print(txt)
x1 = txt1.expandtabs() # 8 space, may be included the letter
x2 = txt1.expandtabs(10)
x3 = txt1.expandtabs(4)
print(x1)
print(x2)
print(x3)
...
txt2 = "\tA"
print(txt2)
x4 = txt2.expandtabs(5)
print(x4)

txt3 = "A\tB"
print(txt3)
x5 = txt3.expandtabs(5)
print(x5)
