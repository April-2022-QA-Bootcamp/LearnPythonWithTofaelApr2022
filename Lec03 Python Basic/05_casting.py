...
# why 16.299999999999997 ?? We can't convert to double type in python.
# the outcome for double and float same because by default it is double
...
a = '5.6666767'
b = '10.745685'
print(int(float(a)) + int(float(b))) # String convert to float, then float convert to Int
